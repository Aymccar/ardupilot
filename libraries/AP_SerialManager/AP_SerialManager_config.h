...
#define AP_SERIALMANAGER_ORIENTUS_BAUD           112500
#define AP_SERIALMANAGER_ORIENTUS_BUFSIZE_RX     384
#define AP_SERIALMANAGER_ORIENTUS_BUFSIZE_TX     168

#define AP_SERIALMANAGER_Dev_BAUD           112500 //placeholder
#define AP_SERIALMANAGER_Dev_BUFSIZE_RX     384  //placeholder
#define AP_SERIALMANAGER_Dev_BUFSIZE_TX     168 //placeholder
